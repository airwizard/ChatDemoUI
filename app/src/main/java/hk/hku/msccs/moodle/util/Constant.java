...
public class Constant {
	...
	public final static String TOKEN_EXPIRE_TIME= "token_expire_time";	
	...
	public static final String DEFAULT_POST_REQUEST_URL="webservice.webxml.com.cn/WebServices/MobileCodeWS.asmx/getMobileCodeInfo";//"http://sip.esgmallt.com/paymentapi/payment/service/getEncryptedPayString";


	public static final String DEFAULT_PORTAL_LOGIN_REQUEST_URL = "https://hkuportal.hku.hk/cas/login?service=http://moodle.hku.hk/login/index.php";
	public static final String DEFAULT_MOODLE_LOGIN_REQUEST_URL = "http://moodle.hku.hk/login/index.php";
